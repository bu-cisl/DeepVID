...
class ClassLoader:
    ...
    from source import network_collection
    from source import generator_collection
    from source import trainor_collection
    from source import inferrence_collection
